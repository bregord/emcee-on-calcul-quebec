...
data_Ary = np.load('A_dataset.npy')  ### LOAD DATA ARRAY HERE ###
...
params_true = np.load('A_params.npy')  ### LOAD TRUE PARAMETERS HERE ###
...
### Run emcee
search_S = 1e4  # Number of MCMC steps to run
samplerP = emcee.EnsembleSampler(nwalkersP,ndimP,data_post,args=[T,Y_d,N,P_rP])
